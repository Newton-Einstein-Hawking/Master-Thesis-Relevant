...
% 用于从以下文本文件导入数据的脚本:
%
%    D:\OneDrive - 南方科技大学\专利申请书\figures\MTF\MTF0mm.txt
%
% 要将代码扩展到其他选定数据或其他文本文件，请生成函数来代替脚本。

% 由 MATLAB 自动生成于 2023/10/13 21:16:49

%% 初始化变量。
filename = 'D:\OneDrive - 南方科技大学\专利申请书\figures\MTF\MTF0mm.txt';
startRow = 2;
...
%% 创建输出变量
MTF0mm = table;
MTF0mm.SpatialFrequency = cell2mat(raw(:, 1));
MTF0mm.Tangential = cell2mat(raw(:, 2));
MTF0mm.Sagittal = cell2mat(raw(:, 3));
